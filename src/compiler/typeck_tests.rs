use super::{
    check_program_types, check_program_types_partial_with_origins, check_program_types_with_origins,
};
        ...
        statements: vec![
            Statement::Expression(Expression::Call {
                ...
                args: vec![Expression::Literal {
                    lit: Literal::Str("hello".to_string()),
                    line: 0,
                    column: 0,
                }],
                type_args: Vec::new(),
...
fn partial_typecheck_can_skip_unchanged_impl_methods() {
    ...
    check_program_types_partial_with_origins(
        ...
        &AnalysisSelection {
            ...
            nested_statement_masks: HashMap::from([("impl::Point".to_string(), vec![true, false])]),
        },
    )
...
fn rejects_reassignment_to_constant() {
    ...
    assert!(
        err.diagnostic()
            .message
            .contains("Cannot reassign constant"),
