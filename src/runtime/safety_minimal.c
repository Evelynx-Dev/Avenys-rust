...
/* Minimal safety support uses libc diagnostics and process termination. */
...
void *rt_closure_env_alloc(int64_t size) { return malloc((size_t)size); }
void rt_closure_env_free(void *env) { free(env); }
